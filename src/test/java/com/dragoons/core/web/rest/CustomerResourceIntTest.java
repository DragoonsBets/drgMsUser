...
import com.dragoons.core.domain.Customer;
import com.dragoons.core.domain.User;
import com.dragoons.core.repository.UserRepository;
import com.dragoons.core.repository.CustomerRepository;
...
import com.dragoons.core.domain.enumeration.Gender;
import com.dragoons.core.domain.enumeration.Role;
/**
...
public class CustomerResourceIntTest {
    ...
    private static final String DEFAULT_EMAIL = "u*@h.My";
    private static final String UPDATED_EMAIL = "Rj@f.>\\";
    ...
    private static final Role DEFAULT_ROLE = Role.BETTER;
    ...
    public void setup() {
        ...
        final CustomerResource customerResource = new CustomerResource(customerRepository, userRepository);
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAvatarContentType()).isEqualTo(DEFAULT_AVATAR_CONTENT_TYPE);
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAvatarContentType()).isEqualTo(UPDATED_AVATAR_CONTENT_TYPE);
